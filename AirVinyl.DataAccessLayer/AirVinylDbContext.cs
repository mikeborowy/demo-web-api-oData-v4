...
namespace AirVinyl.DataAccessLayer
{
    public class AirVinylDbContext : DbContext
    {
        ...
        /// <summary>
        /// Overriden due to use deynamic properties
        /// </summary>
        /// <returns></returns>
        public override int SaveChanges()
        {
            ...
            var modifiedOrAddedVinylRecords = ChangeTracker
                .Entries<VinylRecord>()
                .Where(e => 
            ...
            for (int i = 0; i < modifiedOrAddedVinylRecords.Count; i++)
            {
                ...
                foreach (var dynamicPropertyToSave in dynamicProperties)
                {
                    ...
                    var existingDynamicProperty = ChangeTracker
                        .Entries<DynamicProperty>()
